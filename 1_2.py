...
def process(input, result, results, iteration):
  for number in input:
    ...
    results.add(result)
  iteration += 1
  if iteration % 10 == int(0):
    print(iteration)
  process(input, result, results, iteration)

process(input, result, results, iteration)
#while process(input, result, results) is None:
#  iteration += 1
#  if iteration % 100 == 0:
#    print(iteration)
#  process(input, result, results)
